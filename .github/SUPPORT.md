...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/qsvaR`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/qsvaR),
...
[search issues and pull requests](https://github.com/LieberInstitute/qsvaR/issues)
